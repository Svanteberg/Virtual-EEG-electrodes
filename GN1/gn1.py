...
Input electrodes: F3, P3, F4, P4
Output electrodes: FP1, F7 ,T3, T5, Fp2, F8, T4, T6, C3, O1, C4, O2, A1, A2, FZ, CZ, PZ

The results are saved in a directory: results -> date + start time + 'gn1'; e.g., results/20201012-114948-gn1/.
