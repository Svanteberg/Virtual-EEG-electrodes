...
The file `plot_original_eeg.py` is a tkinter based GUI that can be used to visualize the data (or any EEG saved in the same manner, i.e., size (21,2560) and named: eeg_0.npy, eeg_1.npy, ...)
