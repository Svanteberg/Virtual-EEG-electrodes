...
The data was organized with each individual having a folder containing one or more of their respective EEG recordings. All EEGs in each folder were divided into numpy files of 10 s epochs. A file mapping the numpy files to the indiviuals and EEG recordings was created.
