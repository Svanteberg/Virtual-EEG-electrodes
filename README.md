...
There are several options when using the code that is provided. A simpler step-by-step demo for training a GN1 type network is given here: [demo](https://github.com/Svanteberg/Virtual-EEG-electrodes/blob/master/ste-by-step_demo.md). Further down below, more in-depth information and general instructions are given.
