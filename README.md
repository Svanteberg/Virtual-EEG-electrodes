...
This network recreates the value of any one blocked channel. The signal of the blocked channel is replaced by low amplitude white noise. In addition to recreating the signal, the network therefore also has to learns to detect which channel is missing.
