...
*The developed scripts require that the data is organized in a specific way. This will probably be the hardest problem for anyone attempting to use the scripts, and it will probably save time to instead modify them to accommodate your own data structure.*
